...
import com.cognizant.facilityregistartion.model.Authority;
...
@Component
public class FacilityUserAuthenticationProvider implements AuthenticationProvider {

	@Autowired
	private FacilityUserRepo userRepo;
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		...
		List<FacilityUser> customer = userRepo.findByEmail(username);
		if (customer.size() > 0) {
